...
func registerComponents() {
	...
	jsonFactory.RegisterComponent("Nocturnal", func() ecs.Component { return &rlcomponents.NocturnalComponent{} })
	...
	jsonFactory.RegisterComponent("Material", func() ecs.Component { return &components.MaterialComponent{Quantity: 1} })
	...
	jsonFactory.RegisterComponent("ScriptedAI", func() ecs.Component { return &components.ScriptedAIComponent{} })
	...
	jsonFactory.RegisterComponent("Needs", func() ecs.Component { return &components.NeedsComponent{} })
	jsonFactory.RegisterComponent("Emote", func() ecs.Component { return &components.EmoteComponent{} })
	jsonFactory.RegisterComponent("Hearing", func() ecs.Component { return &components.HearingComponent{} })
	jsonFactory.RegisterComponent("Vision", func() ecs.Component { return &components.VisionComponent{} })
	jsonFactory.RegisterComponent("Smell", func() ecs.Component { return &components.SmellComponent{} })
	jsonFactory.RegisterComponent("Sound", func() ecs.Component { return &components.SoundComponent{} })
	jsonFactory.RegisterComponent("ScentEmitter", func() ecs.Component { return &components.ScentEmitterComponent{} })
}
